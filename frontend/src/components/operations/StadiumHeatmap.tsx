    ...
    <div className="p-6 rounded-2xl border border-[#1f293d] bg-[#121826]/40 shadow-lg space-y-6 flex flex-col justify-between h-full min-h-[500px]">
      ...
      <div className="flex items-center justify-between border-b border-[#1f293d] pb-4">
        ...
        <div className="flex space-x-3 text-[10px] text-gray-500 font-bold uppercase tracking-wider">
          <span className="flex items-center"><span className="w-2 h-2 rounded bg-emerald-500 mr-1.5" />Optimal</span>
          <span className="flex items-center"><span className="w-2 h-2 rounded bg-yellow-500 mr-1.5" />Moderate</span>
          <span className="flex items-center"><span className="w-2 h-2 rounded bg-red-500 mr-1.5" />Congested</span>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-4 relative min-h-[250px]">
        ...
        <svg width="340" height="240" viewBox="0 0 340 240" className="filter drop-shadow-[0_0_12px_rgba(217,160,13,0.08)]">
          ...
          <path 
            ...
            className={`cursor-pointer hover:opacity-90 stroke-2 transition-all ${getStatusColor(mockSectors[0].status)} ${selectedSector?.id === mockSectors[0].id ? 'stroke-white stroke-[3px]' : ''}`}
          />
          ...
          <path 
            ...
            className={`cursor-pointer hover:opacity-90 stroke-2 transition-all ${getStatusColor(mockSectors[1].status)} ${selectedSector?.id === mockSectors[1].id ? 'stroke-white stroke-[3px]' : ''}`}
          />
          ...
          <path 
            ...
            className={`cursor-pointer hover:opacity-90 stroke-2 transition-all ${getStatusColor(mockSectors[2].status)} ${selectedSector?.id === mockSectors[2].id ? 'stroke-white stroke-[3px]' : ''}`}
          />
          ...
          <path 
            ...
            className={`cursor-pointer hover:opacity-90 stroke-2 transition-all ${getStatusColor(mockSectors[3].status)} ${selectedSector?.id === mockSectors[3].id ? 'stroke-white stroke-[3px]' : ''}`}
          />
          ...
          <path 
            ...
            className={`cursor-pointer hover:opacity-90 stroke-2 transition-all ${getStatusColor(mockSectors[4].status)} ${selectedSector?.id === mockSectors[4].id ? 'stroke-white stroke-[3px]' : ''}`}
          />
          ...
          <path 
            ...
            className={`cursor-pointer hover:opacity-90 stroke-2 transition-all ${getStatusColor(mockSectors[5].status)} ${selectedSector?.id === mockSectors[5].id ? 'stroke-white stroke-[3px]' : ''}`}
          />
          ...
          <path 
            ...
            className={`cursor-pointer hover:opacity-90 stroke-2 transition-all ${getStatusColor(mockSectors[6].status)} ${selectedSector?.id === mockSectors[6].id ? 'stroke-white stroke-[3px]' : ''}`}
          />
          ...
          <path 
            ...
            className={`cursor-pointer hover:opacity-90 stroke-2 transition-all ${getStatusColor(mockSectors[7].status)} ${selectedSector?.id === mockSectors[7].id ? 'stroke-white stroke-[3px]' : ''}`}
          />
        </svg>
          ...
          {selectedSector && (
            ...
            >
              <div className="flex justify-between items-center border-b border-[#1f293d] pb-2">
                ...
                <button onClick={() => setSelectedSector(null)} className="text-gray-500 hover:text-white">✕</button>
              </div>
